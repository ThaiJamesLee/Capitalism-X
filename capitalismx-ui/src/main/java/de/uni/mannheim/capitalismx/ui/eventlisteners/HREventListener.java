...
public class HREventListener implements PropertyChangeListener {
	...
	public void propertyChange(PropertyChangeEvent evt) {
		if(evt.getPropertyName().equals("engineerChange")) {
			EmployeeListController contr = (EmployeeListController)Main.getManager().getGameView(GameViewType.HR).getModule(UIElementType.HR_EMPLOYEES_OVERVIEW).getController();
