...
import de.uni.mannheim.capitalismx.ui.controller.popover.hr.TrainingPopoverController;
		...
		if (empty || employee == null) {
			...
			if (loader == null) {
				...
				loader = new FXMLLoader(
						getClass().getClassLoader().getResource("fxml/component/employee_list_cell.fxml"), bundle);
