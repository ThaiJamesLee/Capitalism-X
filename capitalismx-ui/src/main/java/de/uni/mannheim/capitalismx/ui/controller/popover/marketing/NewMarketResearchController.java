...
/**
 * Controller of the overlay that pops up when starting a new
 * {@link MarketResearch}
 * 
 * @author Alex
 *
...
public class NewMarketResearchController implements UpdateableController {
	...
	public void initialize(URL location, ResourceBundle resources) {
		...
		runBtn.setOnAction(e -> {
			...
			// TODO Where to collect neeeded data (metrics? - not clearly defined in the
			// report, some not mentioned at all...)
	...
	/**
	 * Enables the button which can be used create an internal MarketResearch
	...
	/**
	 * Function updates the MarketResearchs ListView in the
	 * {@link MarketResearchListController} Module
	 */
	private void updateMarketResearchsList() {

		MarketResearchListController uiController = (MarketResearchListController) UIManager.getInstance()
				.getModule(GameModuleType.MARKETING_MARKETRESEARCH).getController();
