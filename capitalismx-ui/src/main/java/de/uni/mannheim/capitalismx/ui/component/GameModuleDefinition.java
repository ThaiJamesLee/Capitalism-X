...
public enum GameModuleDefinition {
	...
	PRODUCTION_MACHINERY_LIST("machinery_list.fxml",  GameModuleType.PRODUCTION_MACHINERY_OVERVIEW, new GridPosition(10, 10, 0, 14), true),
	PRODUCTION_PRODUCE_PRODUCT_MENU("produce_product_menu.fxml",  GameModuleType.PRODUCTION_PRODUCE_PRODUCT, new GridPosition(0, 10, 0, 14), true),
	PRODUCTION_INVESTMENTS_MENU("production_investments_menu.fxml", GameModuleType.PODUCTION_INVESTMENT_MENU, new GridPosition(4, 12, 14, 6), true),
