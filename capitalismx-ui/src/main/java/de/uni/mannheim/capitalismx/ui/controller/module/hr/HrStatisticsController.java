...
public class HrStatisticsController extends GameModuleController {
	...
	@FXML
	private Label numberEmployeesProduction, employeeSatisfactionProduction, employeeProductivityProduction, employeeSalariesProduction;
	
	@FXML
	private Label numberEmployeesOverall, employeeSatisfactionOverall, employeeProductivityOverall, employeeSalariesOverall;
	...
	public void initialize(URL arg0, ResourceBundle arg1) {
		...
		employeeProductivityOverall.setText(hrDep.getTotalJSS() + "");
