...
public class HrStatsController extends GameModuleController {
	...
	public void update() {
		Platform.runLater(() -> {
			...
			qowLabel.setText(NumberFormat.getPercentInstance(UIManager.getResourceBundle().getLocale()).format(hrDep.getTotalQualityOfWork()));
			satisfactionLabel.setText(NumberFormat.getPercentInstance(UIManager.getResourceBundle().getLocale()).format(hrDep.getTotalJSS()));
