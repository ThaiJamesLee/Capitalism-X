...
public enum Component implements Serializable {
    ...
    Component(ComponentCategory componentCategory, String componentName, int componentLevel, double initialComponentPrice, int baseUtility, int availabilityDate) {
